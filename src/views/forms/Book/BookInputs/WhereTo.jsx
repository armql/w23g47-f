...
export default function WhereTo() {
  ...
  return (
    <div
      className={`duration-102 relative flex w-full border-r-2 px-1.5 py-1.5 transition sm:rounded-bl-lg md:rounded-bl-lg md:px-1.5 md:py-1.5 lg:rounded-bl-lg xl:rounded-none xl:px-2 xl:py-1.5 ${
        isOpen
    ...
    >
      <div className="flex w-full flex-row items-center justify-start">
        ...
        <input
          ...
          className={`border-2 border-transparent bg-transparent text-sm capitalize text-indigo-950 ring-2 ring-transparent transition duration-300 xl:text-sm ${
            isOpen
