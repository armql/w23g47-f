  ...
  return (
    <Fragment>
      <div className="flex flex-row items-center justify-center">
        <div className="z-10 mx-auto flex flex-col items-center justify-center rounded-l-lg border-2 border-indigo-200 shadow-sm sm:flex-row">
